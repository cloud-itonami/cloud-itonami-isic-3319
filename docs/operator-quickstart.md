# Operator Quickstart — Repair of Other Equipment

Shortest path from clone to a verified local dry-run for **ISIC 3319** (`cloud-itonami-isic-3319`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3319.git
cd cloud-itonami-isic-3319
```
...
- Blueprint governor key: `other-equipment-repair-governor`
- Likely source path: `other_equipment_repair.governor.cljc`
